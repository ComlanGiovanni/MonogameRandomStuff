...
namespace screenShot
{
    public class Sprite : DrawableGameComponent, ICloneable
    {
        ...
        {
            base.Draw(gameTime);
            SpriteBatch.Draw(_texture, Position, null, Color * Opacity, Rotation, HalfTextureSize, Scale, SpriteEffects.None, 0);
        }
        ...
        public object Clone()
        {
            return new Sprite(Game, Texture, Position, SpriteBatch, Scale, Opacity, Rotation, RotationPerUpdate);
        }
    }
}
